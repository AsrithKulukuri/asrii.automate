...
export default function ConnectPage() {
  ...
  const [devIgUsername, setDevIgUsername] = useState("");
  const [devIgUserId, setDevIgUserId] = useState("");
  ...
  return (
    <div className="space-y-8 max-w-4xl">
      ...
      <Button onClick={() => setIsModalOpen(true)} leftIcon={<Key className="w-4 h-4" />}>Connect Instagram Test Account</Button>
          ...
          <Card className="flex flex-col justify-between border-[#2B2B2B]">
            <CardContent className="p-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-[#A3A3A3] mt-1.5 leading-relaxed">
                  Connect using a Instagram API setup Page/User token to test workflows instantly in a sandbox environment before full App Review.
                </p>
              </div>
              <ul className="text-xs text-[#737373] space-y-1.5 list-disc list-inside">
      ...
      <Modal
        ...
        description="Submit your Instagram API setup token for authorized testing. It is encrypted immediately using AES-256-GCM."
      >
        <form onSubmit={handleConnectDeveloperToken} className="space-y-4">
          <div>
            ...
            <p className="text-[11px] text-[#737373] mt-1">
              Obtained from Instagram API setup with instagram_business_manage_comments and instagram_business_manage_messages.
            </p>
          </div>
